...
export function getParametersMonth(parametersMonth, action) {
  ...
  const availableDates = parametersMonth && parametersMonth.availableDates ? parametersMonth.availableDates : [];
...
export const getCalendarDays = (parametersMonth, availableDates = []) => {
